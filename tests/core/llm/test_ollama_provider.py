...
from socialsim4.core.llm.providers.ollama import (
...
# The actual module is at socialsim4.core.llm.validation, not providers.validation.
# Provide a stub so the function body can execute.
_mod = types.ModuleType("socialsim4.core.llm.providers.validation")
_mod.validate_media_url = lambda url: "valid"
sys.modules.setdefault("socialsim4.core.llm.providers.validation", _mod)

from socialsim4.core.llm.providers.ollama import encode_images
