...
PUBLIC_GOODS: Dict[str, Any] = {
    ...
    "parameters": [
        ...
        # Punishment configuration parameters
        {
            "id": "punishment_budget_per_round",
            "key": "punishment_budget_per_round",
            "label": "Punishment Budget per Round",
            "type": "integer",
            "default": 0,
            "ui_hint": "number",
            "min": 0,
            "max": 50,
            "category": "punishment",
            "description": "Punishment tokens each agent receives per round. Set to 0 to disable punishment.",
        },
        {
            "id": "punishment_cost_ratio",
            "key": "punishment_cost_ratio",
            "label": "Cost Ratio (1 token : N payoff deduction)",
            "type": "number",
            "default": 3.0,
            "ui_hint": "number",
            "min": 1.0,
            ...
            "step": 0.5,
            "category": "punishment",
            "description": "How much target payoff is reduced per punishment token spent. Higher values = stronger punishment.",
        },
        {
            "id": "punishment_anonymous",
            "key": "punishment_anonymous",
            "label": "Anonymous Punishment Mode",
            "type": "boolean",
            "default": False,
            "ui_hint": "toggle",
            "category": "punishment",
            "description": "When enabled, targets don't see who punished them (only see 'anonymous').",
        },
    ],
    "actions": [
